...
var h4Elems = document.querySelectorAll('h4');

for(var i = 0; i < h4Elems.length; i++){
  console.log( h4Elems[i]);
  // * It's done when the text of each `<h4>` is set to `blue`, the font size is `30px`, and the text is `bold`.
  h4Elems[i].setAttribute("style", "color: blue; font-size: 30px; font-weight:bold; ");

  // h4Elems[i].style.padding = '10px';
  // h4Elems[i].style.margin = '0';

  h4Elems[i].setAttribute("style", h4Elems[i].getAttribute('style') + "padding: 10px; margin: 0;");
}

document.querySelector("h1").setAttribute("style", "padding: 10px; margin: 0;");
