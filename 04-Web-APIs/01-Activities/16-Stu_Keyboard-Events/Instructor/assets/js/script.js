function keydownAction(event) {
  ...
  // allows me to see keydown events on the page
...
// document.querySelector("#password").addEventListener("keydown", keydownAction);
document.addEventListener("keydown", keydownAction);
// Adds listener for keyup event
// captures key up events via the document
// document.querySelector("#password").addEventListener("keyup", keyupAction);
